...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="IST 27th Batch Group Posts" />
<meta property="og:url" content="https://ist27thbatch.tk/notice/group/" />
...
<meta property="fb:app_id" content="941310122964942" />
        ...
        <title>IST 27th Batch Group Posts</title>
        <meta charset="UTF-8">
...
<body style="text-align:center;">
  ...
  (function(d, s, id){
    ...
    <div class="header">
      ...
      <h1>IST 27th Batch Group Posts</h1>
    ...
    <div id="hamburgerNav" class="overlay">
        ...
        <table class="overlay-content">
            ...
            <tr><td style="cursor: pointer;" onClick="location.replace('https://ist27thbatch.tk/notice/message/');"><i class="fa fa-envelope" aria-hidden="true"></i>
 Load Notices From Message</td></tr>
...
NU CSE Syllabus</td></tr>
    ...
    <?php
        ...
        //if(isset($_POST['button1'])) {
            ...
            //echo nl2br(file_get_contents("../../groupposts/posttxt/2020-06-24_01-12-16_pm_1592982736.txt"));
            
            
            //$file = file_get_contents("../../groupposts/posttxt/".$i);
            //print_r(nl2br($file));
